...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return package01.test.Sample.internal_static_Request_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return package01.test.Sample.internal_static_Request_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            package01.test.Request.class, package01.test.Request.Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof package01.test.Request)) {
      return super.equals(obj);
    }
    package01.test.Request other = (package01.test.Request) obj;
  ...
  public static package01.test.Request parseFrom(
  ...
  public static package01.test.Request parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static package01.test.Request parseFrom(
  ...
  public static package01.test.Request parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static package01.test.Request parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static package01.test.Request parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(package01.test.Request prototype) {
  ...
  public static final class Builder extends
      ...
      package01.test.RequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return package01.test.Sample.internal_static_Request_descriptor;
    }
    ...
    // Construct using package01.test.Request.newBuilder()
    private Builder() {
    ...
    @Override
    public package01.test.Request getDefaultInstanceForType() {
      return package01.test.Request.getDefaultInstance();
    }

    @Override
    public package01.test.Request build() {
      package01.test.Request result = buildPartial();
    ...
    @Override
    public package01.test.Request buildPartial() {
      package01.test.Request result = new package01.test.Request(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof package01.test.Request) {
        return mergeFrom((package01.test.Request)other);
      } else {
    ...
    public Builder mergeFrom(package01.test.Request other) {
      if (other == package01.test.Request.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      package01.test.Request parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (package01.test.Request) e.getUnfinishedMessage();
  ...
  private static final package01.test.Request DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new package01.test.Request();
  }

  public static package01.test.Request getDefaultInstance() {

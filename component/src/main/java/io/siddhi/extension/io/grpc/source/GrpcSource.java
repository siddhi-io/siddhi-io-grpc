...
@Extension(name = "grpc", namespace = "source",
        description = "This extension starts a grpc server during initialization time. The server listens to " +
                ...
                "service mode. By default this uses EventService. Please find the io.siddhi.extension.io.grpc.proto definition [here]" +
                "(https://github.com/siddhi-io/siddhi-io-grpc/tree/master/component/src/main/resources/" +
                "EventService.io.siddhi.extension.io.grpc.proto) In the default mode this source will use EventService consume method. This " +

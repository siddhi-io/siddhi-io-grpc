...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return package01.test.Sample.internal_static_Response_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return package01.test.Sample.internal_static_Response_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            package01.test.Response.class, package01.test.Response.Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof package01.test.Response)) {
      return super.equals(obj);
    }
    package01.test.Response other = (package01.test.Response) obj;
  ...
  public static package01.test.Response parseFrom(
  ...
  public static package01.test.Response parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static package01.test.Response parseFrom(
  ...
  public static package01.test.Response parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static package01.test.Response parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static package01.test.Response parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(package01.test.Response prototype) {
  ...
  public static final class Builder extends
      ...
      package01.test.ResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return package01.test.Sample.internal_static_Response_descriptor;
    }
    ...
    // Construct using package01.test.Response.newBuilder()
    private Builder() {
    ...
    @Override
    public package01.test.Response getDefaultInstanceForType() {
      return package01.test.Response.getDefaultInstance();
    }

    @Override
    public package01.test.Response build() {
      package01.test.Response result = buildPartial();
    ...
    @Override
    public package01.test.Response buildPartial() {
      package01.test.Response result = new package01.test.Response(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof package01.test.Response) {
        return mergeFrom((package01.test.Response)other);
      } else {
    ...
    public Builder mergeFrom(package01.test.Response other) {
      if (other == package01.test.Response.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      package01.test.Response parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (package01.test.Response) e.getUnfinishedMessage();
  ...
  private static final package01.test.Response DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new package01.test.Response();
  }

  public static package01.test.Response getDefaultInstance() {
